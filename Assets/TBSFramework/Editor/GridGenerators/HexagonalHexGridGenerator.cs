        ...
        public override GridInfo GenerateGrid()
        {
            ...
            for (int i = 0; i < Radius; i++)
            {
                for (int j = 0; j < (Radius * 2) - i - 1; j++)
                {
                    ...
                    hexagon.GetComponent<Hexagon>().GridCoordinates = new Vector2IntImpl(i, Radius - j - 1 - (i / 2));
                    ...
                    hexagon2.GetComponent<Hexagon>().GridCoordinates = new Vector2IntImpl(-i, Radius - j - 1 - (i / 2));
                    hexagon2.GetComponent<Hexagon>().GridType = HexGridType.odd_q;
